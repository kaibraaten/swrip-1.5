      ...
      [28206] = 
      {
         ...
         MudProgs = 
         {
            [1] = 
            {
               ...
               Arguments = "100", 
               Code = "mpechoat $n A stray blaster shot hits you.\
mpdamage $n 100\
", 
               ScriptType = "MProg", 
            }, 
...
the eye can see is alive with blaster fire. Corpses litter the ground in\
...
laboratory. The bottom of the cliff is lined up with sensors, blaster\
...
bay doors are always open so incase o emergency the whole bay can be\
...
are the walls You stand in the sleeping quarters for the emergency\
medical facility here you can get a good night's sleep, without any\
interuptions. Blue beds look inviting, neatly made and warm, the\
ceiling is pure, white as are the walls You stand in the sleeping\
quarters for the emergency medical facility here you can get a good\
...
from the broken wires. Through the torn ceiling the low atmosphere of Byss\
is visible to the naked eye. The dark viewscreen displays the rugged\
landscape, you can see AT-ATs marching along loudly, you notice the large\
...
himself designed. Black smoke floats towards the unvisisble ceiling many\
...
TIE cannons, proton torpedoe launchers and various other ship weapons for\
upgrading. A very heavily modified TIE hovers in the room, equiped to\
...
walls. There is a secret shuttle bay in the back so it's easy to smuggle\
      ...
      [28209] = 
      {
         ...
         MudProgs = 
         {
            [1] = 
            {
               ...
               Code = "mptransfer $n\
feel heal $n\
mpecho You are lowered into the bacta...\
mpecho The bacta envelopes you...\
mptransfer $n 28244\
", 
               ScriptType = "MProg", 
            }, 
      ...
      [28210] = 
      {
         ...
         MudProgs = 
         {
            [1] = 
            {
               ...
               Arguments = "25", 
               Code = "mpecho the nurse injects a small amount of tranqualizer into your blood.\
mpforce $n sleep\
", 
               ScriptType = "MProg", 
            }, 
      ...
      [28212] = 
      {
         ...
         MudProgs = 
         {
            [1] = 
            {
               MudProgType = "all_greet_prog", 
               Arguments = "100", 
               Code = "mpecho I'd like to do a little ditty for a listener named Streen.\
mpecho called JIMMY RAY!!!...\
", 
               ScriptType = "MProg", 
            }, 
            [2] = 
            {
               MudProgType = "all_greet_prog", 
               Arguments = "100", 
               Code = "mpecho Dan: Are you Johnny Ray, who wants to know? are you Slim Ray? who wants to know? Are you Fay Wray? who wants to know? who wants to know? Are you Sting Ray? Who wants to know?\
", 
               ScriptType = "MProg", 
            }, 
            [3] = 
            {
               MudProgType = "all_greet_prog", 
               Arguments = "100", 
               Code = "force $n give 50 credits Dan\
", 
               ScriptType = "MProg", 
            }, 
         }, 
...
Say thank you\
mpechoat $n The guard escorts you into the lab.\
mpechoaround $n The guard escorts $n into the lab.\
mptransfer $n 28243\
mpat 28243 mpechoaround $n $n is escorted in by a guard.\
mpat 1 drop all\
mpat 1 mppurge\
else\
say Thats not the right card\
drop all\
endif\
", 
               ScriptType = "MProg", 
