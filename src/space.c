...
{
  "Tocca", 0, 32410, 0,
    { SHUTTLESTOP_NONEXISTANT, SHUTTLESTOP_CORULAG, SHUTTLESTOP_CORELLIA, SHUTTLESTOP_ADARI, SHUTTLESTOP_NONEXISTANT, SHUTTLESTOP_NONEXISTANT, SHUTTLESTOP_NONEXISTANT, SHUTTLESTOP_NONEXISTANT },
    { "Ord Mantell", "Corulag", "Corellia", "Adari", "Roche", "Sullust", "Kuat", "Ord Mantell" }

},
{
  "Cassia", 0, 32425, 0,
    { SHUTTLESTOP_NONEXISTANT, SHUTTLESTOP_CORELLIA, SHUTTLESTOP_NONEXISTANT, SHUTTLESTOP_TATOOINE, SHUTTLESTOP_RYLOTH, SHUTTLESTOP_GAMORR, SHUTTLESTOP_CORELLIA, SHUTTLESTOP_NONEXISTANT },
    { "Byss", "Corellia", "Af'el", "Tatooine", "Ryloth", "Gamorr", "Corellia", "Byss" }

},
{
  "Siego", 0, 32435, 0,
    { SHUTTLESTOP_CORUSCANT, SHUTTLESTOP_CORELLIA, SHUTTLESTOP_NONEXISTANT, SHUTTLESTOP_HOTH, SHUTTLESTOP_NONEXISTANT, SHUTTLESTOP_NONEXISTANT, SHUTTLESTOP_NONEXISTANT, SHUTTLESTOP_CORUSCANT },
    { "Coruscant", "Corellia", "Bespin", "Hoth", "Endor", "Wroona", "Byss", "Coruscant"}

},
{
  "Amose", 0, 32445, 0,
    { SHUTTLESTOP_NONEXISTANT, SHUTTLESTOP_NONEXISTANT, SHUTTLESTOP_NONEXISTANT, SHUTTLESTOP_TATOOINE, SHUTTLESTOP_GAMORR, SHUTTLESTOP_MONCALAMARI, SHUTTLESTOP_NONEXISTANT, SHUTTLESTOP_NONEXISTANT },
    { "Endor", "Bespin", "Sullust", "Tatooine", "Gamorr", "Mon Calamari", "Ord Mantell", "Endor"}

},
{
  "Edena", 0, 32440, 0,
    { SHUTTLESTOP_NONEXISTANT, SHUTTLESTOP_CORUSCANT, SHUTTLESTOP_CORULAG, SHUTTLESTOP_NONEXISTANT, SHUTTLESTOP_CORELLIA, SHUTTLESTOP_ADARI, SHUTTLESTOP_NONEXISTANT, SHUTTLESTOP_NONEXISTANT },
    { "Byss", "Coruscant", "Corulag", "Kuat", "Corellia", "Adari", "Wroona", "Byss"}

},
{
  "Odani", 0, 32450, 0,
    { SHUTTLESTOP_NONEXISTANT, SHUTTLESTOP_NONEXISTANT, SHUTTLESTOP_KASHYYYK, SHUTTLESTOP_NONEXISTANT, SHUTTLESTOP_NONEXISTANT, SHUTTLESTOP_CORELLIA, SHUTTLESTOP_ADARI, SHUTTLESTOP_NONEXISTANT },
...
{
    SHUTTLESTOP_CORUSCANT ,  SHUTTLESTOP_MONCALAMARI , SHUTTLESTOP_ADARI , SHUTTLESTOP_GAMORR , SHUTTLESTOP_TATOOINE , SHUTTLESTOP_RYLOTH , 6264, SHUTTLESTOP_KASHYYYK , 3060 , 28247, 32297, 2065, SHUTTLESTOP_CORELLIA, SHUTTLESTOP_HOTH
};
int     const   bus_vnum2 [MAX_BUS_STOP] =
{
    SHUTTLESTOP_CORUSCANT, SHUTTLESTOP_HOTH ,  SHUTTLESTOP_CORELLIA , 2065 , 32297 , 28247 , 3060 , SHUTTLESTOP_KASHYYYK , 6264, SHUTTLESTOP_RYLOTH , SHUTTLESTOP_TATOOINE, SHUTTLESTOP_GAMORR, SHUTTLESTOP_ADARI, SHUTTLESTOP_MONCALAMARI
};
