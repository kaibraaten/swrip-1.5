...
struct serin_shuttle serin[MAX_BUS] =
  {
    ...
    {
      "Edena", 0, 32440, 0,
      { SHUTTLESTOP_NONEXISTANT, SHUTTLESTOP_CORUSCANT, SHUTTLESTOP_CORULAG, SHUTTLESTOP_KUAT, SHUTTLESTOP_CORELLIA, SHUTTLESTOP_ADARI, SHUTTLESTOP_NONEXISTANT, SHUTTLESTOP_NONEXISTANT },
