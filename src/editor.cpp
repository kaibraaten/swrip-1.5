...
public:
    ...
    void List(std::shared_ptr<Character>, std::string) const;
    void FormatLines(std::shared_ptr<Character>, std::string);
    void Abort(std::shared_ptr<Character>) const;
    void Save(std::shared_ptr<Character>) const;
...
void Editor::FormatLines(std::shared_ptr<Character> ch, std::string argument)
{
    EditorLine *eline = first_line;
...
void Editor::PrintInfo(std::shared_ptr<Character> ch) const
{
    int i = 0;
    EditorLine *eline = first_line;
...
void Editor::Help(std::shared_ptr<Character> ch, std::string argument) const
{
    int i = 0;
...
void Editor::DeleteLine(std::shared_ptr<Character> ch, std::string arg)
{
...
void Editor::List(std::shared_ptr<Character> ch, std::string argument) const
{
    int from = 0, to = 0;
    std::string arg1;
...
void Editor::Abort(std::shared_ptr<Character> ch) const
{
    ch->Echo("\r\n&RAborting... &d");
    StopEditing(ch);
}
