...
void do_trajectory_actual(std::shared_ptr<Character> ch, std::string argument)
{
    ...
    Vector3 argvec = Vector3(std::stod(arg2), std::stod(arg3), std::stod(argument));

    if(argvec == ship->Position)
    {
