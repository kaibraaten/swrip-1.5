...
void do_drag(std::shared_ptr<Character> ch, std::string argument)
{
    ...
    if(victim->Position < POS_STANDING)
    {
        ...
        Act(AT_ACTION, "You drag $M into the next room.", ch, NULL, victim, ActTarget::Char);
        Act(AT_ACTION, "$n grabs your hair and drags you.", ch, NULL, victim, ActTarget::Vict);
        MoveCharacter(victim, GetExit(ch->InRoom, exit_dir));
