...
extern const char* const attack_table[];
...
extern const char * const weapon_table[];
...
extern const char * const crystal_table[];
...
#define SH      SHIP_DATA
  ...
  int get_rflag( const char* );
  int get_exflag( const char* );
